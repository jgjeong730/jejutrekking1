...
export const REAL_SCHEDULE: OlleDay[] = [
  ...
  { day: 10, date: '2026-11-02', accommodation: 'guesthouse', course: '6코스', courseIds: [6],               section: '쇠소깍 → 서귀포올레여행자센터',             distance: 11.0, cumulative: 173.1, lodge: '서귀포 올레 게스트하우스',     lat: 33.2515, lng: 126.5622, routeIdx: 11 },
  { day: 11, date: '2026-11-03', accommodation: 'guesthouse', course: '7-1코스', courseIds: [7.1],             section: '제주월드컵경기장 → 서귀포올레여행자센터',   distance: 15.0, cumulative: 188.1, lodge: '서귀포 올레 게스트하우스 연박', lat: 33.2515, lng: 126.5622, routeIdx: 11 },
